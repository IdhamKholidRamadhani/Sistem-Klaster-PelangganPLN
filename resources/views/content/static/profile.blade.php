            ...
            <div
                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="overflow-x-auto p-7">
                        ...
                        <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-3.5 py-1.5 rounded">Data Instansi</span>
                        <form>
                            ...
                            <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-3.5 py-1.5 rounded">Data Akun</span>
                            <div class="mt-4 mb-3">
